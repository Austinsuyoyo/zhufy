  ...
  >
    ...
    <div class="flex items-center gap-2 md:gap-4">
      <button
        ...
        class="flex items-center gap-1 md:gap-2 bg-orange-700 hover:bg-orange-800 text-white font-bold py-1.5 md:py-2 px-2 md:px-4 rounded-lg transition shadow-lg hover:shadow-orange-500/50 text-sm md:text-base"
        aria-label="重置畫布"
      >
      ...
      <div class="relative flex items-center">
        <button
          ...
          class="flex items-center gap-1 md:gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-1.5 md:py-2 px-3 md:px-6 rounded-lg transition shadow-lg hover:shadow-blue-500/50 text-sm md:text-base"
          aria-label="下載圖片"
        >
        ...
        <button
          ...
          class="ml-1 p-1.5 md:p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition"
          aria-label="選擇下載解析度"
